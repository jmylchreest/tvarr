...
- SQLite/PostgreSQL/MySQL (configurable via GORM) - existing `manual_stream_channels` table (019-manual-stream-sources)
...
## Recent Changes
- 019-manual-stream-sources: Added Go 1.25.x (backend), TypeScript/Next.js 16.x (frontend)
